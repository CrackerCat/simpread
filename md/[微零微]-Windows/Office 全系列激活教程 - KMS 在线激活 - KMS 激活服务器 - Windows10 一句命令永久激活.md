> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [v0v.bid](https://v0v.bid/kms.html)
...
但，被分享到公网的 KMS 激活服务器，已通过技术手段突破了内网限制，不被内网约束。因此，只要你的电脑可以连接互联网，便不会失去授权名额。
...
# 微软 Windows 操作系统（Office 套件）UUP 补丁镜像库：  
https://uupdump.ml  
