> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.52pojie.cn](https://www.52pojie.cn/thread-1953016-1-1.html)

> [md] 个人博客原文链接：https://www.kn0sky.com/?p=938527f1-03c4-4349-8110-5510f7d4b84a## 前言我第一次做这套练习是在初学 pwn 的时候，隐......

![](https://avatar.52pojie.cn/data/avatar/001/51/81/42_avatar_middle.jpg)kn0sky

![](https://attach.52pojie.cn/forum/202408/09/154941e3zjr5gygtn5v33e.png)

**image-20240409231656-51bt6se.png** _(100.42 KB, 下载次数: 0)_

[下载附件](forum.php?mod=attachment&aid=MjcxNjA2OXw4MjE4OWIzY3wxNzIzMzQxNzkwfDB8MTk1MzAxNg%3D%3D&nothumb=yes)

2024-8-9 15:49 上传

[b] 个人博客原文链接：[https://www.kn0sky.com/?p=938527f1-03c4-4349-8110-5510f7d4b84a](https://www.kn0sky.com/?p=938527f1-03c4-4349-8110-5510f7d4b84a)  
...
```
ret2win ➤ ./exp_cli.py '/home/selph/ctf/rop_emporium_all_challenges/ret2win/ret2win'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    No canary found
    NX:       NX enabled
    PIE:      No PIE (0x400000)
[+] Starting local process '/home/selph/ctf/rop_emporium_all_challenges/ret2win/ret2win': pid 3847 Switching to interactive mode
...
> Thank you!
Well done! Here's your flag: Process '/home/selph/ctf/rop_emporium_all_challenges/ret2win/ret2win' stopped with exit code 0 (pid 3847)
...
```
split ➤ ./exp_cli.py '/home/selph/ctf/rop_emporium_all_challenges/split/split'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    No canary found
    NX:       NX enabled
    PIE:      No PIE (0x400000) '/usr/lib/x86_64-linux-gnu/libc.so.6'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    Canary found
    NX:       NX enabled
...
    00000040  0a                                                  │·│
    00000041 Switching to interactive mode
...
Contriving a reason to ask user for data... Process '/home/selph/ctf/rop_emporium_all_challenges/split/split' stopped with exit code -11 (SIGSEGV) (pid 7405) Got EOF while reading in interactive
```
...
```
callme ➤ ./exp_cli.py '/home/selph/ctf/rop_emporium_all_challenges/callme/callme'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    No canary found
    NX:       NX enabled
    PIE:      No PIE (0x3fe000)
    RUNPATH:  b'.' '/home/selph/glibc-all-in-one/libs/2.23-0ubuntu11.3_amd64/libc-2.23.so'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    Canary found
    NX:       NX enabled
...
    000000a0  0a                                                  │·│
    000000a1 Switching to interactive mode
...
ROPE{a_placeholder_32byte_flag!} Process '/home/selph/ctf/rop_emporium_all_challenges/callme/callme' stopped with exit code 0 (pid 23451) Got EOF while reading in interactive
```
...
```
write4 ➤ ./exp_cli.py '/home/selph/ctf/rop_emporium_all_challenges/write4/write4'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    No canary found
    NX:       NX enabled
    PIE:      No PIE (0x400000)
    RUNPATH:  b'.' '/usr/lib/x86_64-linux-gnu/libc.so.6'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    Canary found
    NX:       NX enabled
...
    SHSTK:    Enabled
    IBT:      Enabled
[+] Starting local process '/home/selph/ctf/rop_emporium_all_challenges/write4/write4' argv=[b'/home/selph/ctf/rop_emporium_all_challenges/write4/write4'] : pid 28217 Loaded 13 cached gadgets for 'write4'
...
    00000060  0a                                                  │·│
    00000061 Switching to interactive mode
...
> Thank you!
ROPE{a_placeholder_32byte_flag!} Process '/home/selph/ctf/rop_emporium_all_challenges/write4/write4' stopped with exit code -11 (SIGSEGV) (pid 28217) Got EOF while reading in interactive
```
...
```
fluff.zip.d ➤ python3 exp.py '/home/selph/ctf/CTF_selph/rop_emporium_all_challenges/x64/fluff.zip.d/fluff'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    No canary found
    NX:       NX enabled
...
    00000190  0a                                                  │·│
    00000191 Switching to interactive mode
...
```
pivot.zip.d ➤ ./exp_cli.py debug pivot '/home/selph/ctf/CTF_selph/rop_emporium_all_challenges/x64/pivot.zip.d/pivot'
    Arch:     amd64-64-little
    RELRO:    Partial RELRO
    Stack:    No canary found
    NX:       NX enabled
...
![](https://avatar.52pojie.cn/images/noavatar_middle.gif)yan999 赞！！！![](https://avatar.52pojie.cn/images/noavatar_middle.gif)A-boy 好好好好好 ![](https://avatar.52pojie.cn/images/noavatar_middle.gif) w1066602520 感觉相当复杂的感觉。![](https://avatar.52pojie.cn/images/noavatar_middle.gif)tianxingjian146 可以可以可以 ![](https://avatar.52pojie.cn/images/noavatar_middle.gif) zjh889 谢谢楼主，俺们学习了！![](https://avatar.52pojie.cn/images/noavatar_middle.gif)binghe01 我也想 pwn 呀，师傅加油 ![](https://avatar.52pojie.cn/data/avatar/001/51/81/42_avatar_middle.jpg) kn0sky

> [binghe01 发表于 2024-8-10 00:35](https://www.52pojie.cn/forum.php?mod=redirect&goto=findpost&pid=51042019&ptid=1953016)  
> 我也想 pwn 呀，师傅加油

想 pwn 就 pwn 啊 ![](https://avatar.52pojie.cn/images/noavatar_middle.gif) offerking 支持，学习了