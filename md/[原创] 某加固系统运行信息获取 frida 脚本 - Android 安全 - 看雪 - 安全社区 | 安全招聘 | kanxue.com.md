> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [bbs.kanxue.com](https://bbs.kanxue.com/thread-266013.htm)

> [原创] 某加固系统运行信息获取 frida 脚本

某加固系统运行信息获取 frida 脚本，具体使用请自行探索。

```
/*
Get xxxjiagu info Script
                    by fxyang
                   辛丑年正月初一
 */
...
    // 这个函数过于敏感，故隐去代码，需要的自己去获取vmp主函数地址填充。
    vmp_fun_addr = 0;
}
 
if (mprotect != 0) {
...
[#工具脚本](forum-161-1-128.htm) [#混淆加固](forum-161-1-121.htm)